...
export const imageMap = {
  ...
  // --- TAMPÕES (Substituindo os arquivos perdidos pela imagem da mulher) ---
  'age-18-29-couple': ageWoman1829, 
  'age-18-29-couple-new': ageWoman1829,
  'age-30-39-couple': ageWoman1829,
  'age-40-49-couple': ageWoman1829,
  'age-50-plus-couple': ageWoman1829,
  
  // --- MASCOTES (Também usando o tampão) ---
  'age-couple-18-29-mascot': ageWoman1829,
  'age-couple-30-39-mascot': ageWoman1829,
  'age-couple-40-49-mascot': ageWoman1829,
  'age-couple-50-plus-mascot': ageWoman1829,
