...
import genderMaleMascot from '@/assets/gender-male-mascot.jpg';
import genderFemaleMascot from '@/assets/gender-female-mascot.jpg';
...
import bodyZonesFemaleMascot from '@/assets/body-zones-female-mascot-final.png';
...
import bodyOverweightMaleShorts from '@/assets/body-chubby-male-smaller.jpg';
...
// Mascot body type images (legacy - keeping for backwards compatibility)
...
export const imageMap = {
  'age-woman-1': ageWoman1829,
  'age-woman-2': ageWoman3039,
  'age-woman-3': ageWoman4049,
  'age-woman-4': ageWoman50Plus,
  'gender-male-mascot': genderMaleMascot,
  'gender-female-mascot': genderFemaleMascot,
  ...
  'goal-slim-female-mascot': goalSlimFemaleReal,
  'goal-athlete-female-mascot': goalAthleteFemaleReal,
